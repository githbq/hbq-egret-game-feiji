 ...
 */
    ...
    function GetParams(url, c) {
     ...
     if (window.localStorage && localStorage["page_player"]) {
       
    }else if (window.localStorage&&localStorage["page_plane"]){
    	 localStorage["page_player"] = JSON.stringify(GetParams());
    }
    else if (window.localStorage && !localStorage["page_plane"]) {
        localStorage["page_plane"] = "123";
