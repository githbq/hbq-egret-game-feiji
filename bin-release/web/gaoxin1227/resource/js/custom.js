 ...
 */
    ...
    if (window.localStorage && localStorage["feiji_short"]) {
        localStorage["feiji_data"] = JSON.stringify(GetParams());
    }
    else if (window.localStorage && !localStorage["feiji_short"]) {
        localStorage["feiji_short"] = "123";
...
url.pop();
url = url.join('/');
var imgUrl = url + '/resource/images/pintu.png';  //注意必须是绝对路径
//加载第一个图片
